...
t(
  'EEO null -> decline option',
  chooseOption(['Male', 'Female', 'Prefer not to say'], 'Prefer not to say', 'eeo_gender'),
  'Prefer not to say'
);
t(
  'EEO empty -> decline option',
  chooseOption(['Male', 'Female', 'Decline to self-identify'], '', 'eeo_gender'),
  'Decline to self-identify'
);
t(
  'EEO with no decline option -> null (do NOT guess)',
  chooseOption(['Male', 'Female'], '', 'eeo_gender'),
  null
);
t(
  'exact match',
  chooseOption(['Bachelor', 'Master', 'PhD'], 'Master', 'education_degree'),
  'Master'
);
t(
  'ambiguous substring -> null',
